    ...
    <Stack direction={['column', 'row']} h={'100vh'}>
      <VStack w={'full'}>
        ...
        <VStack alignItems={'flex-start'} p={'8'} w={'full'} overflow={'auto'}>
          ...
          <Text>
            This is a sample video Lorem ipsum dolor sit amet consectetur
            adipisicing elit. Voluptates, eaque?Lorem ipsum dolor sit amet
            consectetur, adipisicing elit. Saepe, quo!
          </Text>
        </VStack>
      </VStack>
      <VStack
